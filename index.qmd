...
:::::::: columns
:::::: {.column width="60%"}
@taylor2020 - Examining possession chains as player interaction networks

<br />

::::: inline-fragment
::: fragment
Focus: Kick-in chains from all matches played in the 2015 AFL season
...
- Edge list
- Adjacency matrix
- Visualise possession networks as sociograms
- Calculate network metrics: Degree centrality, density, cluster coefficient,
entropy
:::
:::::
::::::
...
::: {.column width="40%"}
![](images/kickin.jpg){.absolute top="10%" right="0" height="40%"}
:::
::::::::

## Example: Sociogram for one AFL team

![](images/taylor_sociogram.png){.absolute left="15%" height="70%"}

## A useful method for quantifying passing interactions

More successful kick-in chains:

:::::: inline-fragment
::: fragment
- Comprised more direct ball movement - [lower network density]{.yellow}
:::

::: fragment
- Were less predictable - [higher entropy]{.yellow}
:::
::::::
...
- By analysing sequential possession data as interaction networks, we can [quantify patterns]{.cyan} in passing between players
:::
::: fragment
- Useful for [testing beliefs]{.cyan} based on visual judgments, [scouting opponents]{.cyan}
:::
::::::
