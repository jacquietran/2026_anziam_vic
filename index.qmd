...
``` {r plot_chain_A, echo = FALSE, fig.height = 8}
...
```{r plot_chain_B, echo = FALSE, fig.height = 8}
...
oval +
  ...
  ggrepel::geom_label_repel(
    ...
    ggplot2::aes(
      ...
      y = disp_y_start,
      label = label_chain_b),
    seed = 359, segment.colour = NA,
    position = ggpp::position_nudge_center(
      x = -10, center_x = 0, direction = "split"),
    direction = "y") +
  ggplot2::scale_fill_manual(
    values = c(
      "RICH" = "#ffbf00",
...
```{r plot_chain_C, echo = FALSE, fig.height = 8}
