...
- Fiona Fairhurst - Inspired by sharks' dermal denticles
- Reduced drag, greater thrust (@oeffner2012)

:::

::: {.column width="40%"}
![](images/6382565.jpg){.absolute top="10%" right="0" height="30%"}
![](images/Dermal Denticles colour SEM.jpg){.absolute top="50%" right="0" height="40%"}
:::
:::::
...
**Honours - Sports Biomechanics**<br /><br />
Working with [wearable sensors]{.yellow} developed for sport and [3-D motion capture]{.yellow}
:::
...
[**A young field growing rapidly**]{.mimic-title .absolute left="12%" top="15%"}

## Technology changes

Increased use of video

Commercial accessibility of wearable and portable technologies

Moving beyond count statistics to detailed event records (play-by-play)

Multi-camera optical tracking systems (e.g., Hawk-Eye)
...
Data storage - Integrating data from multiple sources (across disciplines)
...
Even still, there is a lot that is exciting about [change and maturation]{.yellow}!

## {background-color="#0e172b" background-image="images/pawel-czerwinski-eybM9n4yrpE-unsplash.jpg" background-opacity="0.7"}

[**Signal processing**]{.mimic-title .absolute left="51%" top="15%"}

## Signal processing

Advancements in wearable technology

Need for signal processing techniques to work with noisy data, identify meaningful activities (e.g., based on movement intensity, accelerations / decelerations, sleep phases)

## {background-color="#0e172b" background-image="images/" background-opacity="0.7"}

[**Fluid dynamics**]{.mimic-title .absolute left="51%" top="15%"}

## {background-color="#0e172b" background-image="images/Stoppage_in_an_AFL_game.jpg" background-opacity="0.7"}

[**Analysing patterns of play**]{.mimic-title .absolute left="51%" top="15%"}
...
[**Video annotation**]{.mimic-title .absolute left="51%" top="15%"}
